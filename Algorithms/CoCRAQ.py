...
for episode in range(start_from_episode+1, num_episodes):
    ...
    while not (done or truncated):
        ...
        qdevice1.update_q_table(state1, action, reward, next_state1)
        qdevice2.update_q_table(state2, action, reward, next_state2)
        qdevice3.update_q_table(state3, action, reward, next_state3)
